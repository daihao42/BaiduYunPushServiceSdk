...
class RequestCore(object):
    ...
    def handle_request(self):
        ...
        self.response_headers = resp_str[0 : header_size].decode()
        #self.response_body = resp_str[header_size : ]
        self.response_body = resp_str[header_size : ].decode()
